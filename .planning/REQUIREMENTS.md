...
Requirements for responsive/mobile web milestone. Each maps to roadmap phases.
...
| Feature | Reason |
|---------|--------|
| Pull-to-refresh | Web pattern, not needed for internal tool |
| Offline support | Always connected, NAS-hosted |
| Native app gestures | Web-first, standard touch is sufficient |
| PWA installation | Nice-to-have but not essential for 3-person team |
| Swipe-to-delete | Confirmation dialogs are safer |
