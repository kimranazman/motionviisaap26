# Plan 78-05: Main Calendar Orchestrator Component
...
Create the MainCalendar component that orchestrates the three view components (day, week, month), handles view switching, navigation, and detail sheet integration.

## Tasks

<task id="1">
Create the MainCalendar component at `src/components/calendar/main-calendar.tsx`:
...
import { type CalendarItem, getEntityColor, formatEntityType } from './calendar-date-marker'
...
export function MainCalendar({ tasks, projects, initiatives }: MainCalendarProps) {
  ...
  // Handle item click - open appropriate detail sheet
...
- Data transformation to CalendarItem[]
- Completed status detection
- Click handlers that open detail sheets
- Legend showing entity types and date type indicators
- Integration with TaskDetailSheet, ProjectDetailSheet, InitiativeDetailSheet
</task>

## Verification

- [ ] File exists at `src/components/calendar/main-calendar.tsx`
- [ ] MainCalendar component exported
- [ ] View mode toggle (day/week/month) works
- [ ] Navigation buttons work (prev/next/today)
- [ ] Title updates based on view mode
- [ ] Data transformed to CalendarItem[]
- [ ] Completed items detected correctly
- [ ] Click opens appropriate detail sheet
- [ ] Legend shows entity types and date types
- [ ] No TypeScript errors

## must_haves

- View mode switching (CAL-08)
- Day, week, month navigation
- Data transformation with isCompleted flag
- Detail sheet integration (CAL-12)
