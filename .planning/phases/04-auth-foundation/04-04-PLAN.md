...
9. Add SignOutButton to dashboard temporarily (or test via browser console: await fetch('/api/auth/signout', {method: 'POST'}))
10. Click sign out button
11. Verify: Redirected to /login page
12. Test with non-@talenta.com.my account (use personal Gmail)
13. Verify: Redirected to /access-denied page
...
- [x] Sign out returns user to login page
...
<check>Sign out functionality works</check>
</verification>
