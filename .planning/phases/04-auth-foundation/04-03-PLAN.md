---
plan: 04-03
title: Login Page and Access Denied Page
wave: 3
depends_on: ["04-02"]
files_modified:
...
# Plan 04-03: Login Page and Access Denied Page

## Objective
Create the branded login page with Google sign-in button and the access denied page for rejected domain users.

## Context
This plan creates the user-facing auth pages:
...
<check>Run `npm run build` - no TypeScript errors in auth pages</check>
